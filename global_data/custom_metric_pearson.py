...
def pearson_correlation(dataframe_y_true, dataframe_y_pred):
    """
        Calculates the Pearson Correlation for a sample
    ...
    score = np.corrcoef(dataframe_y_true['TARGET'], dataframe_y_pred['TARGET'])[0,1]
